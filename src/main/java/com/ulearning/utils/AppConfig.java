...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	@Bean
	public PaymentController getLessonController() {
	...
	@Bean(name="followerDao")
	public IFollowerDao followerDao() {
		return new FollowerDaoImpl();
	}
	...
	@Bean(name="learnerService")
	public ILearnerService learnerService() {
		return new LearnerServiceImpl();
	}
	@Bean(name="learnerDao")
	public ILearnerDao learnerDao() {
		return new LearnerDaoImpl();
	}
	@Bean(name="learningSessionService")
	public ILearningSessionService learnerSessionService() {
		return new LearningSessionServiceImpl();
	}
	@Bean(name="learningSessionDao")
	public ILearningSessionDao learningSessionDao() {
		return new LearningSessionDaoImpl();
	}
